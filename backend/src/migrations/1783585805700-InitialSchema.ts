...
export class InitialSchema1783585805700 implements MigrationInterface {
    name = 'InitialSchema1783585805700'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "expenses" ("id" SERIAL NOT NULL, "label" character varying(255) NOT NULL, "amount" numeric(10,2) NOT NULL, "type" character varying(10) NOT NULL, "date" date NOT NULL, "isRecurring" boolean NOT NULL DEFAULT false, "user_id" integer, "category_id" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_94c3ceb17e3140abc9282c20610" PRIMARY KEY ("id"))`);
